...
%The sampled synchrotron emission parameters, $A_{\rm synch}^{220}$ and $\alpha_{\rm synch}$, are used to scale the 1.4 GHz profile to the ACT frequencies.
%The sum of the SZ, dust, synchrotron, and DC offset signals are compared to the stacked profile at 148 GHz. 
%The sum of the dust, synchrotron, and DC offset signals are compared to the stacked profile at 220 GHz.
%The sampled dust SED is compared to the mean source flux densities for each of the HerS bands.
